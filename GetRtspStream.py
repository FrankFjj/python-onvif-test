...
#         return [(res.Width, res.Height) for res in config.H264.ResolutionsAvailable]
    ...
    def get_rtsp(self):
        ...
        return res_uri
ip_add = input("pls input ip address:")
user_name = input("pls input username:")
password = input("pls input password: ")
#my_ipcam = CameraONVIF('192.168.13.237','admin', 'edge2021')
my_ipcam = CameraONVIF(ip_add, user_name, password)

my_ipcam.camera_start()
print(my_ipcam.get_rtsp())
time.sleep(10)